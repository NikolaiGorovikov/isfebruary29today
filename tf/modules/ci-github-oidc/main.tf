...
data "aws_iam_policy_document" "assume_role" {
  statement {
    ...
    principals {
      type        = "Federated"
      identifiers = ["arn:aws:iam::927414202992:oidc-provider/token.actions.githubusercontent.com"]
    }
